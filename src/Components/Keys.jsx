...
const Keys=()=>{
    return(
        <div className="content-block">
            <h1 className="content-title">Ключи</h1>
            ...
            `}</code></pre></div>
            <div className="content-text">
              <p>Лучший способ выбрать ключ — это использовать строку, которая будет явно отличать элемент списка от его соседей. Чаще всего вы будете использовать ID из ваших данных как ключи:</p></div>
            <div className="content-code"><pre><code>{`
