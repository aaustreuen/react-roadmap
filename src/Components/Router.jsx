    ...
    return (
        <div className="content-block">
            ...
            <div className="content-text"><p>
                После установки нужно импортировать BrowserRouter, Routes, Route:</p></div>
            <div className="content-code"><pre><code>{`
            ...
            `}</code></pre></div>
            <div className="content-text"><p>
                Компонент-оболочка для любых маршрутов, которые мы хотим отобразить, называется Routes. Внутри Routes мы будем использовать компонент Route для каждой страницы, которую хотим отобразить.</p></div>
            <div className="content-code"><pre><code>{`
                      import React from "react";
